...
<section class="container page-intro legal-page">
  <div class="legal-layout">
    ...
    <div class="legal-section">
      ...
      <p>
        ...
        34119 Kassel<br>
        E-Mail: kontakt@dodidis-media.de
      </p>
    </div>
    ...
    <div class="legal-section">
      ...
      <p>Beim Aufrufen unserer Website werden automatisch folgende Informationen erfasst:</p>
      <ul>
        <li>IP-Adresse</li>
      ...
      <p>Diese Daten dienen ausschließlich der Sicherstellung eines störungsfreien Betriebs sowie zur Verbesserung unseres Angebots.</p>
    ...
    <div class="legal-section">
      ...
      <p>Diese Daten werden ausschließlich zur Erstellung und Bereitstellung des Tickets verwendet.</p>
    ...
    <div class="legal-section">
      ...
      <p>Diese Daten werden ausschließlich für den Versand von Informationen zu unseren Events verwendet.</p>
    ...
    <div class="legal-section">
      ...
      <ul>
        <li>Ticketdaten: bis zur Durchführung des Events + angemessene Nachfrist</li>
        <li>Newsletterdaten: bis zum Widerruf</li>
